...
//            echo "<div id='demo' class='alert alert-danger  user-select-none' role='alert'><span class='d-flex justify-content-center '>User already exists!!</span> <span class='d-flex justify-content-center'>Sign in</span></div>";
         ...
         if($_POST["email"]!= "" ){
            ...
            if($result= mysqli_query($conn, $query)){
              ...
              if($em != $row["email"] ){
                ...
                //mail when account is succesfully crweated
                      // $to ="$em";
                      // $subject = "hello";
                      // $message = "<Congratulations!!<br>Your account has been successfully created";
                      // $headers = "MIME-Version: 1.0" . "\r\n";
                      // $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
                      // $headers .= 'From: shivam5162323@ninjaweb516.com' . "\r\n" . 'X-Mailer: PHP/' . phpversion();
                      ...
                      // mail($to, $subject, $message, $headers);
                        ...
                        $to ="$em";
                        $subject = "Ninja Web";
                        $htmlContent = file_get_contents("s1.html") ;
                          // $headers .= "Reply-To: The Sender <shivam5162323@ninjaweb516.com>\r\n"; 
                          // $headers .= "Return-Path: The Sender <shivam5162323@ninjaweb516.com>\r\n"; 
                          // $headers .= "From: The Sender <shivam5162323@ninjaweb516.com>\r\n";  
                          $headers .= "Reply-To: shivam5162323@ninjaweb516.com"."\r\n"; 
                          $headers .= "Return-Path: shivam5162323@ninjaweb516.com"."\r\n"; 
                          $headers .= 'From: shivam5162323@ninjaweb516.com'."\r\n";  
                          $headers .= 'Organization: 	shivam5162323@ninjaweb516.com'."\r\n";
...
$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
    ...
    <div class=" container mt err">
        <div class="jumbotron ">
          ...
          <p class="f-1 d-flex justify-content-center text-light user-select-none" id="su" >Interested? Sign up now!</p>
        </div>
        <center>
          <form method="post" >
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="d-flex justify-content-center">
              <div class="text-light p-4 user-select-none" id="si">Sign in</a></div>
                </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
        ...
        <script>
          ...
          document.getElementById("si").onclick = function(){
            location.href='https://ninjaweb516-com.stackstaging.com/7-mysql/diarysignin.php';
